          ...
          sx={{
            ...
            '&::before': {
              ...
              background: sector?.color
                ? `linear-gradient(135deg, ${sector.color} 0%, transparent 58%)`
                : 'none',
              opacity: 0.08,
            },
          }}
          ...
          >
            <Avatar
              sx={{
                width: 56,
                height: 56,
                bgcolor: sector?.color ?? 'primary.main',
                fontSize: 19,
                fontWeight: 700,
              }}
            >
          ...
          <Stack spacing={3}>
            <Section title="Identificação">
              <DetailGrid>
                ...
                <Detail
                  ...
                  value={formatDateOnly(row.birthDate, 'Não informado')}
                />
            ...
            <Section title="Acolhimento">
              <DetailGrid>
                ...
                <Detail
                  label="Família / prontuário"
                  value={row.familyCode}
                  mono
                />
                <Detail
                  label="Responsável familiar"
                  value={row.familyResponsible}
                />
                ...
                {loadingFamilia ? (
                  ...
                  <Stack spacing={1.5}>
                    <DetailGrid>
                      ...
                      <Detail
                        label="Responsavel"
                        value={familia.responsavelNome}
                      />
                      <Detail
                        label="Setor principal"
                        value={familia.setorNome}
                      />
                      <Detail
                        label="Membros ativos"
                        value={familia.acolhidosCount}
                      />
                    </DetailGrid>
                    <Stack spacing={1}>
                        ...
                        >
                          <Box sx={{ minWidth: 0 }}>
                            ...
                            <Typography
                              ...
                              color="text.secondary"
                            >
                              {valueOrFallback(membro.kinship)} | Leito{' '}
                              {valueOrFallback(membro.bed)}
                            </Typography>
                          </Box>
                          <Chip
                            size="small"
                            color={membro.active ? 'success' : 'default'}
                            label={membro.active ? 'Ativo' : 'Saiu'}
                          />
                        </Box>
                      ))}
                    </Stack>
          ...
          <Stack direction="row" spacing={1} useFlexGap flexWrap="wrap">
            ...
            {row.familyId ? (
              <Button
                ...
                variant="contained"
                startIcon={<LogoutIcon />}
                onClick={() => onAction('exitFamily', row)}
              >
